...
use DBWorker\DataMapper\Type\Common;
...
Type::getInstance()
    ->register('common', '\DBWorker\DataMapper\Type\Common')
    ->register('datetime', '\DBWorker\DataMapper\Type\Datetime')
    ->register('integer', '\DBWorker\DataMapper\Type\Integer')
    ->register('json', '\DBWorker\DataMapper\Type\Json')
    ->register('number', '\DBWorker\DataMapper\Type\Number')
    ->register('pg_array', '\DBWorker\DataMapper\Type\PgsqlArray')
    ->register('pg_hstore', '\DBWorker\DataMapper\Type\PgsqlHstore')
    ->register('string', '\DBWorker\DataMapper\Type\Text')
    ->register('uuid', '\DBWorker\DataMapper\Type\UUID')
    ->register('complex', '\DBWorker\DataMapper\Type\Complex');
