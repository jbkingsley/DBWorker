...
abstract class Adapter extends \DBWorker\Service
{
    protected $handler;
    ...
    public function connect(): \PDO
    {
        ...
        try {
            ...
            Logger::debug('database connected', ['dsn' => $dsn]);
            ...
            throw new \DBWorker\Service\Exception('Database connect failed!', 0, $exception);
        }
    ...
    public function disconnect()
    {
        if ($this->isConnected()) {
            ...
            Logger::debug('database disconnected', ['dsn' => $this->getConfig('dsn')]);
        }
    ...
    /**
     * @return \DBWorker\Service\DB\Table
     */
